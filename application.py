...
def edit_investigation(id):
    ...
    if request.method=='POST':
        ...
        pui  = request.form.get('pending_ui')
        dui  = request.form.get('dispose_ui')
        ...
        print(pui,dui,put,dut,plt3,dlt3,p3,d3,d6,p6,p12,d12,sep=' ')
...
def marksform():
    ...
    if iform.validate_on_submit():
       newmarks = marks( d = iform.date.data, nps =  iform.ps_name.data ,pocsic=iform.percent_of_cases_submitted_in_court.data,cohc=iform.cases_of_henius_crime.data,
                        cap=iform.crime_against_property.data,n=iform.ndps.data,cr= iform.commercial_recovery,
                        ac= iform.arm_act.data,ea =iform.excise_act.data,ga= iform.gambling_act.data ,
                        podoc=iform.percent_of_disposal_of_complaints.data,popd=iform.percent_of_property_disposal.data,
                        aop=iform.arrest_of_po.data,ucpic= iform.untrace_cases_put_in_court.data,ne =iform.negligence.data,
                        c= iform.cleanliness.data ,hol= iform.handling_of_law.data)
       db.session.add(newmarks)
       db.session.commit()
